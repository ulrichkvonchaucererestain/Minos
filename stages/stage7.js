...
function buildStage7Platforms() {
  ...
  MAP.platforms = [
    { id: "startFloor", x: 0, y: FLOOR_Y, w: 620, h: ph },
    { id: "dropA", x: 780, y: loftY, w: 240, h: TILE },
    { id: "dropB", x: 1180, y: mezzY, w: 260, h: TILE },
    { id: "doorPlatform1", x: 1580, y: FLOOR_Y, w: 420, h: ph },
    { id: "needleBridge", x: 2260, y: galleryY, w: 300, h: TILE },
    { id: "spikeHigh", x: 2860, y: loftY, w: 520, h: TILE },
    { id: "shaftTop", x: 3600, y: FLOOR_Y, w: 320, h: ph },
    { id: "lowerRun", x: 4180, y: lowerY, w: 390, h: ph },
    { id: "doorPlatform2", x: 4740, y: lowerY, w: 500, h: ph },
    { id: "spikeLower", x: 5520, y: lowerY, w: 440, h: ph },
    { id: "stair1", x: 6160, y: rise1Y, w: 220, h: TILE },
    { id: "stair2", x: 6490, y: rise2Y, w: 230, h: TILE },
    { id: "stair3", x: 6830, y: rise3Y, w: 250, h: TILE },
    { id: "fireballStart", x: 7200, y: mezzY, w: 370, h: TILE },
    { id: "fireballEnd", x: 7700, y: galleryY, w: 330, h: TILE },
    { id: "doorPlatform3", x: 8140, y: FLOOR_Y, w: 300, h: ph },
  ];
...
var buildPlatforms = buildStage7Platforms;

window.addEventListener("load", function () {
  buildPlatforms = buildStage7Platforms;
});

function stage7PlatformPoint(platformId, objectW, objectH, offsetX) {
...
function initStage2Doors() {
  ...
  var door1 = stage7PlatformPoint("doorPlatform1", dW, dH);
  var door2 = stage7PlatformPoint("doorPlatform2", dW, dH);
  var door3 = stage7PlatformPoint("doorPlatform3", dW, dH);
  ...
  MAP.doors = [
    {
      ...
      hint: "The first door anchors the mid-floor route.",
    },
    {
      x: door2.x,
      y: door2.y,
      ...
      hint: "The second door waits in the lower run.",
    },
    {
      x: door3.x,
      y: door3.y,
      ...
      hint: "The final door stands at the far end.",
    },
  ];
...
function initStage2SpikeTraps() {
  var spikeHigh = MAP.platformById.spikeHigh;
...
function initStage2Pots() {
  ...
  var selected = [
    stage7PlatformPoint("dropB", potW, potH, 90),
    stage7PlatformPoint("lowerRun", potW, potH, 260),
    stage7PlatformPoint("stair2", potW, potH, 90),
  ];
